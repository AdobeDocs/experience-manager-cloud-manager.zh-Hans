...
完成[!UICONTROL Cloud Manager]的常规配置后，即可使用它。

>[!NOTE]
>
>根据[!UICONTROL Cloud Manager]中分配的角色和应用程序的状态，您看到的屏幕与插图中的屏幕有所不同。
...
1. 如果您的项目尚未配置，请单击[call-to-action](/help/getting-started/navigation.md#cta)中的&#x200B;**设置项目**&#x200B;以配置项目描述并定义关键绩效指标(KPI)。 如果您的项目已配置，CTA会提供额外的后续步骤。

您可以继续查看文档[程序设置](/help/getting-started/program-setup.md)，了解配置程序的后续步骤。

## Cloud Manager 活动 {#activity}

Cloud Manager提供了项目活动的综合视图。 它列出了所有 CI/CD 管道执行情况，包括生产和非生产执行情况。 此功能提供有关历史活动和当前活动的信息。

...
>[!TIP]
>
>请参阅文档 [程序和程序类型](/help/getting-started/program-setup.md) 了解计划的详细信息。
...
1. 通知图标带有标记，显示当前分配的未完成数量 [通知。](/help/using/notifications.md)
...
1. 通过快速入门链接，您可以访问 [入门文档历程](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/onboarding/journey/overview) 以启动并运行Cloud Manager。
   * 请注意，入门培训历程是为AEMas a Cloud Service设计的，不是Cloud ServiceAMS，但许多概念是相同的。
...
* 数量 [部署](/help/using/code-deployment.md)
* 数量 [代码质量问题](/help/using/code-quality-testing.md) 已识别
* 内部版本数
...
* 项目图像（如果已配置）
* 项目名称
* 服务类型： **Experience Manager云** 对象 [AEMas a Cloud Service程序](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/implementing/home) 或 **Experience Manager** 用于AMS程序
* [项目类型](/help/getting-started/program-setup.md)：沙盒或生产
* 状态
* 配置的解决方案
* 创建日期
...
* 导航到特定 [环境](/help/using/managing-environments.md) 的
* 打开 [项目概述](#program-overview)
* [编辑项目](/help/getting-started/program-setup.md)
* 显示监控

#### “许可证”选项卡 {#license-tab}

此 **许可证** 选项卡可让您快速访问许可证仪表板。
...
* 概述 — 当前文档中所述的程序概述
* [活动](/help/using/managing-pipelines.md#activity)  — 程序的管道运行历史记录
* [管道](/help/using/managing-pipelines.md#pipelines)  — 为项目配置的所有管道
* [存储库](/help/managing-code/repositories.md)  — 为项目配置的所有存储库
* [报表](/help/using/monitoring-environments.md#system-monitoring-overview)  — 指标，如SLA数据
* [环境](/help/using/managing-environments.md)  — 为项目配置的所有环境
...
行动号召部分将根据项目的状态为您提供有用的信息。 对于新计划，您可以看到提供的后续步骤以及上线日期提醒， [在程序创建期间设置。](/help/getting-started/program-setup.md)

对于实时项目，显示上次部署的状态，其中包含详细信息链接和开始新部署的链接。

![行动号召](assets/info-banner.png)
...
请参阅文档 [管理环境](/help/using/managing-environments.md) 有关如何管理环境的详细信息。
...
请参阅文档 [管理管道](/help/using/managing-pipelines.md) 有关如何管理管道的详细信息。

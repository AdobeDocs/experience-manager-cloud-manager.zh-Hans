...
1. 通过“快速入门”链接，您可以访问[入门文档历程](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/onboarding/journey/overview)，以便快速开始使用 Cloud Manager。

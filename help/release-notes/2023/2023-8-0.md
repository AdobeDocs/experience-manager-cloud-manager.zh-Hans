...
description: 这些是Cloud Manager 2023.8.0发行说明。
...
# Cloud Manager 2023.8.0发行说明 {#release-notes}

本页记录了[!UICONTROL Cloud Manager] 2023.8.0的发行说明。
...
[!UICONTROL Cloud Manager] 2023.8.0的发布日期是2023年8月10日。 下一个版本计划于2023年9月7日发布。

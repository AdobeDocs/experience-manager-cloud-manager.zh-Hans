...
* **支持AEM Experience Hub中的用户界面可扩展性。**
  ...
  [AEM Experience Hub](https://experienceleague.adobe.com/zh-hans/docs/experience-manager-65/content/experience-hub/experience-hub)中的用户界面扩展支持功能现已启用。 这使开发人员能够使用Adobe App Builder构建的自定义功能和小组件扩展界面。

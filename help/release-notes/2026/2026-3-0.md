...
现已在[AEM Experience Hub](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/experience-hub/experience-hub)中启用对UI扩展的支持。 这使开发人员能够使用Adobe App Builder构建的自定义功能和小组件扩展界面。

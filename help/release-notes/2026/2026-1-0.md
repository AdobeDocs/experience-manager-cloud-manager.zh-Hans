...
[Experience Hub](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/experience-hub/experience-hub)是AEM的接入点，可根据贵组织的需求进行自定义。 为Adobe提供有关现有AEM UI扩展的详细信息，以便它们可以帮助您在Experience Hub中高效启用它们。

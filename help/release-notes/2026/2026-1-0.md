...
要在即将发布的功能正式发布之前获得对该功能的独家访问权，请参与Cloud Manager的Beta计划。

目前提供以下机会：

### Experience Hub 可扩展性和自定义 {#exp-hub-extensibility}

[Experience Hub](https://experienceleague.adobe.com/zh-hans/docs/experience-manager-65/content/experience-hub/experience-hub)是AEM的接入点，可根据贵组织的需求进行自定义。 为Adobe提供有关现有AEM UI扩展的详细信息，以便它们可以帮助您在Experience Hub中高效启用它们。
...
是否参与测试版？ 向 [beta_exphubextensibility@adobe.com](mailto:beta_exphubextensibility@adobe.com) 发送电子邮件，其中包含您的 Adobe OrgID 以及要创建自定义设置的简短说明。
...
参与？ 向 [beta_quickbuild_cmpipelines@adobe.com](mailto:beta_quickbuild_cmpipelines@adobe.com) 发送电子邮件，其中包含您的 Adobe OrgID 和项目群 ID。

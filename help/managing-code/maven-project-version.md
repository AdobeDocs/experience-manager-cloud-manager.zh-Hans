...
如果原始版本符合这些条件，则生成的版本会作为新版本区段追加到原始版本。 此外，系统会略微修改生成的版本以包括正确的排序和版本处理。 例如，假设生成的版本为 `2019.926.121356.0000020490`：
...
>[!NOTE]
>
>无论原始版本是否集成到由 Cloud Manager 发起的版本中，它仍然可以作为名为  `cloudManagerOriginalVersion` 的 Maven 属性访问。

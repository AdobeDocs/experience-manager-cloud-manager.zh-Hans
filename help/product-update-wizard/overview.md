...
产品更新向导是使用Cloud Manager升级到最新版本Adobe Experience Manager 6.5的引导式连续升级体验。 它使用 Cloud Manager 的 CI/CD 框架和内置的自动化测试，简化了端到端流程并确保遵循 AEM 最佳实践。
...
已登记到 Cloud Manager 并有资格升级到 AEM 6.5 的客户可以使用产品更新向导。 有关更多详细信息，请联系您的客户成功代表。

1. 您通过Cloud Manager收到推送通知，告知您AEM 6.5适用于您的项目。

1. **[!UICONTROL AEM 6.5 更新]**&#x200B;信息卡显示在 [!UICONTROL Cloud Manager] 概述屏幕上。 此信息卡会跟踪您在更新过程中的当前阶段，并通知您下一个所需的步骤。
